...
class DatasetCatalog(object):
    DATA_DIR = "../COO-data/MTSv3_data"
    # DATA_DIR = "/share/mhliao/MaskTextSpotterV3/datasets/"

    DATASETS = {
        "COO_train": ("train_images", "train_gts"),
        "COO_bbox": ("train_images", "train_gts_bbox"),
        "COO_val": ("val_images", "val_gts"),
        "COO_test": ("test_images", "test_gts"),
        "coco_2014_train": (
            "coco/train2014",
        ...
        "rotated_ic13_test_0": (
            "icdar2013/rotated_test_images_0",
            "icdar2013/rotated_test_gts_0",
        ),
        "rotated_ic13_test_15": (
            "icdar2013/rotated_test_images_15",
            "icdar2013/rotated_test_gts_15",
        ),
        "rotated_ic13_test_30": (
            "icdar2013/rotated_test_images_30",
            "icdar2013/rotated_test_gts_30",
        ),
        "rotated_ic13_test_45": (
            "icdar2013/rotated_test_images_45",
            "icdar2013/rotated_test_gts_45",
        ),
        "rotated_ic13_test_60": (
            "icdar2013/rotated_test_images_60",
            "icdar2013/rotated_test_gts_60",
        ),
        "rotated_ic13_test_75": (
            "icdar2013/rotated_test_images_75",
            "icdar2013/rotated_test_gts_75",
        ),
        "rotated_ic13_test_85": (
            "icdar2013/rotated_test_images_85",
            "icdar2013/rotated_test_gts_85",
        ),
        "rotated_ic13_test_90": (
            "icdar2013/rotated_test_images_90",
            "icdar2013/rotated_test_gts_90",
        ),
        "rotated_ic13_test_-15": (
            "icdar2013/rotated_test_images_-15",
            "icdar2013/rotated_test_gts_-15",
        ),
        "rotated_ic13_test_-30": (
            "icdar2013/rotated_test_images_-30",
            "icdar2013/rotated_test_gts_-30",
        ),
        "rotated_ic13_test_-45": (
            "icdar2013/rotated_test_images_-45",
            "icdar2013/rotated_test_gts_-45",
        ),
        "rotated_ic13_test_-60": (
            "icdar2013/rotated_test_images_-60",
            "icdar2013/rotated_test_gts_-60",
        ),
        "rotated_ic13_test_-75": (
            "icdar2013/rotated_test_images_-75",
            "icdar2013/rotated_test_gts_-75",
        ),
        "rotated_ic13_test_-90": (
            "icdar2013/rotated_test_images_-90",
            "icdar2013/rotated_test_gts_-90",
        ),
    ...
    def get(name):
        ...
        elif "total_text" in name or "COO" in name or "bbox" in name:
            data_dir = DatasetCatalog.DATA_DIR
