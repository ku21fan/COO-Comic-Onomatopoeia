...
if __name__ == "__main__":
    ...
    score_det = 0.4  # 0.3 or 0.4 is best?
    score_rec = 0.5
    use_lexicon = False
    score_rec_seq = 0.9

    # ### for valid set
    # results_dir = "../../best_model/val/inference/COO_val/MTSv3.pth_seg_results/"
    # cache_dir = "./cache_files_val"
    # gt_zip_file = "../gt_val.zip"
