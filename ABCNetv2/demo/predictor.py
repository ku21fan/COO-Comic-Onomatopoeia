        ...
        if "panoptic_seg" in predictions:
            ...
            if "instances" in predictions:
                ...
                for bezier in beziers:
                    ...
                    vis_output = visualizer.draw_polygon(
                        poly, "green", edge_color=None, alpha=0.5
                    )

                # from https://github.com/facebookresearch/detectron2/blob/c470ca31d2b54d038b9e78f48d1d8e1a8debcc68/detectron2/utils/visualizer.py#L274-L277
                # https://github.com/facebookresearch/detectron2/blob/c470ca31d2b54d038b9e78f48d1d8e1a8debcc68/detectron2/utils/visualizer.py#L1095-L1125
