...
class TextEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        ...
        # else:
        #     with open(
        #         self.use_customer_dictionary, "r", encoding="utf-8-sig"
        #     ) as char_set:
        #         character = char_set.readlines()[0].strip()
        #         self.CTLABELS = list(character)
        ...
        elif "COO_val" in dataset_name:
            self._text_eval_gt_path = "../COO-data/ABCNetv2_data/gt_COO_val.zip"
            self._word_spotting = False
        elif "COO_test" in dataset_name:
            self._text_eval_gt_path = "../COO-data/ABCNetv2_data/gt_COO_test.zip"
            self._word_spotting = False
        else:
    ...
    def to_eval_format(self, file_path, temp_dir="temp_det_results", cf_th=0.5):
        ...
        with open(file_path, "r") as f:
            data = json.load(f)
            tmp_txt = f"temp_all_det_cors_{datetime.now().microsecond}.txt"
    ...
    def evaluate(self):
        ...
        file_path = os.path.join(self._output_dir, f"text_results_{date_time}.json")
        ...
        # eval text
        temp_dir = f"temp_det_results_{datetime.now().microsecond}/"
