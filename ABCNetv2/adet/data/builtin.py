...
_PREDEFINED_SPLITS_TEXT = {
    "COO_train": ("train_images", "train.json"),
    "COO_train_bbox": ("train_images", "train_bbox.json"),
    "COO_val": ("val_images", "val.json"),
    "COO_test": ("test_images", "test.json"),
...
def register_all_coco(root="../COO-data/ABCNetv2_data"):
    for key, (image_root, json_file) in _PREDEFINED_SPLITS_PIC.items():
        # Assume pre-defined datasets live in `./datasets` -> ../COO-data/ABCNetv2_data.
