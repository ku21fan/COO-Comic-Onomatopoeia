...
class Checkpoint:
    ...
    def save(self, update, iteration=None, update_best=False, metric_value=False):
        ...
        if metric_value:
            with open(f"{self.ckpt_foldername}/Log_best_model.txt", "a") as log_best:
                log_best.write(f"{iteration}\t{metric_value:0.5f}\n")
